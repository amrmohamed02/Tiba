            ...
            <div class="nav">
                <div class="inner">
                    ...
                    <div class="nav__content">
                        <ul class="nav__list">
                            ...
                            <li class="nav__list-item nav__list-dropdown">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Single Post sidebar</a></li>
                                </ul>
                            </li>
                        ...
                        <address>
                            Egypt<br>
                            Damietta,El-Mahalla El-Kubra,<br>
                            010-245 506 , 01004392260
                        </address>
                    </div>
                </div>
            ...
            <nav class=" accent-menu main-navigation">
                <ul class="extend-container">
                    <li class="custom-drop-down">
                        <a href="/about" target="_blanck">ABOUT</a>
                        <!--<ul>
                            <li><a href="index.html">Main Demo</a></li>
                            <li><a href="demo-overlaymenu.html">overlay Menu</a></li>
                            <li><a href="demo2.html">One Item</a></li>
                            <li><a href="demo3.html">Full Width</a></li>
                            <li><a href="demo-light.html">Light Demo</a></li>
                            <li><a href="404.html">404 Page</a></li>
                        </ul>-->
                    </li>
                    <li class="custom-drop-down">
                        <a href="/products" target="_blanck">PRODUCTS</a>
                    ...
                    <li><a href="contact.html">projects & news</a></li>
                    <li>
    ...
    <main class="root">
        <div class="dsn-grid-color">
            <div class="dsn-grid-root dsn-grid-slider">
                ...
                <!-- Slider Content -->
                <div class="dsn-grid-content dsn-demo">
                    <div class="dsn-grid-wrapper">

                        <!-- Slider Prev -->
                        <div class="dsn-grid-prev">
                            <div class="img cover-bg" data-id="3" data-image-src="assets/img/slider-3.jpg"></div>
                            <div class="img cover-bg" data-id="1" data-image-src="assets/img/slider-1.jpg"
                                data-overlay="2"></div>
                            <div class="img cover-bg" data-id="2" data-image-src="assets/img/slider-2.jpg"></div>
                        </div>
                        <!-- End Slider Prev -->
                        ...
                        <div class="dsn-grid-info">
                            <div class="dsn-grid-info-wrapper dsn-slider-active" data-id="1" data-url="project1.html">
                                ...
                                <ul class="slide-meta mb-20">
                                    ...
                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Services</span>
                                        <span class="slide-meta__value">Lorem Ipsum is simply dummy text of the printing</span>
                                    </li>

                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Client</span>
                                        <span class="slide-meta__value">University of Tübingen</span>
                                    </li>

                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Agency</span>
                                        <span class="slide-meta__value">Personal Project</span>
                                    </li>

                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Year</span>
                                        <span class="slide-meta__value">2018</span>
                                    </li>
                                </ul>

                                <a href="#" class="custom-btn">
                                    <span class="custom-btn__label">View Project</span>
                            ...
                            <div class="dsn-grid-info-wrapper" data-id="2" data-url="project2.html">
                                ...
                                <ul class="slide-meta mb-20">
                                    ...
                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Year</span>
                                        <span class="slide-meta__value">2019</span>
                                    </li>
                                </ul>
                            ...
                            <div class="dsn-grid-info-wrapper" data-id="3" data-url="project3.html">
                                ...
                                <ul class="slide-meta mb-20">
                                    ...
                                    <li class="slide-meta__item">
                                        <span class="slide-meta__title">Services</span>
                                        <span class="slide-meta__value">- Visual Identity , - Website, -
                                            Wordpress</span>
                                    </li>
                        ...
                        <!-- Slider veiw Box -->
                        <div class="dsn-grid-current dsn-full">
